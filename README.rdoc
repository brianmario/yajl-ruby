...
Some ideas are parsing logs in JSON format, an [ActiveSupport patch](http://github.com/technoweenie/rails/commit/f9abcc93a3660fcf46172c4cd8a2f36ba5a5510d), Rack middleware, use with ohai, JSON API clients, etc...
