...
describe "JSON Gem compatability API" do
  it "shoud not mixin #to_json on base objects until compatability has been enabled" do
    ...
    expect(d.respond_to?(:to_json)).not_to be_true
    expect("".respond_to?(:to_json)).not_to be_true
    expect(1.respond_to?(:to_json)).not_to be_true
    expect("1.5".to_f.respond_to?(:to_json)).not_to be_true
    expect([].respond_to?(:to_json)).not_to be_true
    expect({:foo => "bar"}.respond_to?(:to_json)).not_to be_true
    expect(true.respond_to?(:to_json)).not_to be_true
    expect(false.respond_to?(:to_json)).not_to be_true
    expect(nil.respond_to?(:to_json)).not_to be_true
  end
